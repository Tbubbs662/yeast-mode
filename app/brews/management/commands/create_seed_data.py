...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        demoRecipe1 = Recipe.objects.create(name='Saison', brew_type='Beer', style='Saison', description='This is a mild saison.', owner=demoUser) 
        ...
        demoRecipe2 = Recipe.objects.create(name='Cyber Red', brew_type='Beer', style='Red Ale', description='This is an Irish Red Ale.', owner=demoUser)
